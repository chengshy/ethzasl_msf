 ...
 */
#ifndef POSITION_POSE_YAW_SENSOR_MANAGER_H
#define POSITION_POSE_YAW_SENSOR_MANAGER_H
...
#include <msf_updates/PositionPoseYawSensorConfig.h>

namespace msf_updates {

typedef msf_updates::PositionPoseYawSensorConfig Config_T;
typedef dynamic_reconfigure::Server<Config_T> ReconfigureServer;
typedef shared_ptr<ReconfigureServer> ReconfigureServerPtr;

class PositionPoseYawSensorManager : public msf_core::MSF_SensorManagerROS<
    msf_updates::EKFState> {
  typedef PositionPoseYawSensorManager this_T;
 ...
 public:
  ...
  PositionPoseYawSensorManager(
      ros::NodeHandle pnh = ros::NodeHandle("~/position_pose_yaw_sensor")) {
    imu_handler_.reset(
  ...
  virtual ~PositionPoseYawSensorManager() {
  }
 ...
 private:
  ...
  virtual void Config(Config_T &config, uint32_t level) {
    ...
    if ((level & msf_updates::PositionPoseYawSensor_SET_HEIGHT)

 ...
 */
#ifndef VISION_SENSORHANDLER_HPP_
#define VISION_SENSORHANDLER_HPP_
#include <msf_core/msf_types.h>
#include <msf_core/eigen_utils.h>

namespace msf_vision_sensor {
template<typename MANAGER_TYPE>
VisionSensorHandler<MANAGER_TYPE>::VisionSensorHandler(
...
template<typename MANAGER_TYPE>
void VisionSensorHandler<MANAGER_TYPE>::SetNoises(double n_zp, double n_zq) {
  n_zp_ = n_zp;
  n_zq_ = n_zq;
}

template<typename MANAGER_TYPE>
void VisionSensorHandler<MANAGER_TYPE>::SetDelay(double delay) {
  delay_ = delay;
}


template<typename MANAGER_TYPE>
void VisionSensorHandler<MANAGER_TYPE>::MeasurementCallback(
  ...
  shared_ptr<msf_updates::vision_measurement::VisionMeasurement> meas(
      new msf_updates::vision_measurement::VisionMeasurement(
...
#endif  // VISION_SENSORHANDLER_HPP_

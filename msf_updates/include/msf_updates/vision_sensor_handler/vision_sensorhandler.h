 ...
 */
#ifndef VISION_SENSOR_H_
#define VISION_SENSOR_H_
...
class VisionSensorHandler : public msf_core::SensorHandler<
 ...
 public:
  VisionSensorHandler(MANAGER_TYPE& meas, std::string topic_namespace,
...
#include "implementation/vision_sensorhandler.hpp"

#endif  // VISION_SENSOR_H_
